    ...
    def test_generate_service_code(self):
        ...
        expected_contents = {
            ...
            "servey_stub/greeter_http/greeter/greeter.py": [
                ...
                "        }",
                '        result_ = http_utils.invoke("https://greeter.com/say-hello", "get", event_)',
                "        loaded_result_ = marshy.load(result_)",
                "        return loaded_result_",
                "",
                "",
                "    def save_number_stats(self, NumberStats):",
                "        event_ = {",
                '            "number_stats": marshy.dump(number_stats, NumberStats),',
                "        }",
                '        result_ = http_utils.invoke("https://greeter.com/save-number-stats", "post", event_)',
                "        loaded_result_ = marshy.load(result_)",
                "        return loaded_result_",
                "",
                "",
